...
public class DoctorSkillEducationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public DoctorSkillEducationAdapter(List<Education> mList) {
        this.mList = mList;
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int i) {
        ...
        myViewHolder.tvTitle.setText(mList.get(i).getInstitute());
        myViewHolder.tvSubTitle.setText(getSubTitle(mList.get(i)));
    }

    private String getSubTitle(Education education) {
        String subTitle = "";
        if(!TextUtils.isEmpty(education.getDegree())){
            subTitle += education.getDegree();
        }
        if(!TextUtils.isEmpty(education.getCompletionYear())){
            subTitle += "\n"+education.getCompletionYear();
        }
        return subTitle;
    }
